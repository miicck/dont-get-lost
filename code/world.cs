...
public class world : MonoBehaviour
{
    ...
    public const float MOUNTAIN_SIZE = MAX_ALTITUDE / 2f;
    public const float MOUNTAIN_PERIOD = 3.342f * MAX_ALTITUDE;
    public const float HILL_SIZE = MAX_ALTITUDE / 8f;
    public const float HILL_PERIOD = 0.435f * MAX_ALTITUDE;
    ...
    // How mountainous a particular point is
    ...
    // How hilly a particular point is
    ...
    public static float altitude(float x, float z)
    {
        ...
        float a = m * MOUNTAIN_SIZE + h * HILL_SIZE;
